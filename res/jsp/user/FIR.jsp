...
<div class="success" id="message" >	
	<p> FIR Successfully Registered.....!</p>
</div>
</div>
...
<div class="container">
	<section id="content">
		<form action="<%=request.getContextPath()%>/RegisterFir" method="post" >
			<h2>Register FIR</h2>
			<!-- <div>
			...
			<div>
				<input type="text" placeholder="Name" required="" name="username" required="yes"/>
			</div>
			<div>
			...
			<div>
				<input type="text" placeholder="Enter FIR Content" required="" name="fir_report" required="yes" />
			</div>
			<!-- <div>
				<input type="text" placeholder="Email ID" required="" name="email" required="yes" pattern="\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" />
			</div> -->
			<div style="position: absolute;top: 250px;left: 120px;">
