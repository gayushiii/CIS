...
%>
		<div class="success" id="message">	
			<p>Criminal Image Searching Process Done Successfully.....</p>
		</div>				
<%
	}
	if(no==2)
...
<div class="TabMenu" style="position: relative;left:0px;text-align: center;">
	...
	<h2 style="color: #000000">Search Image<h2>
</div>	
		  ...
		  <table align="center" id="login">
		    <form action="<%=request.getContextPath()%>/res/jsp/user/view_file.jsp" method="post">
		 	...
		 	<tr align="center">
		 			...
		 			<td align="center">
							<font color="black" size="4"> Not found </font>
		 			</td>
		 	</tr>
...
<%		
	...
	{
%>
		<div class="success" id="message" style="position: absolute;top: 200px;left:100px;">	
			<p>Image Not Found in Database....</p>
		</div>				
<%
	}
%>
...
<%-- <%
	...
	{
%>
		<div class="success" id="message" style="position: absolute;top: 30px;left:100px;">	
			<p>Eye Image Not Found in Database.....</p>
		</div>				
<%
	}
%> --%>
