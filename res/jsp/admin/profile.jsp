...
<form action="<%=request.getContextPath()%>/res/jsp/admin/editProfile.jsp" >
<center>
<h1>PROFILE</h1>
<%
while(rs.next())
...
<td><input type="text" name="uid" value="<%=adminName%>"readonly="readonly"></td></tr>

<tr><td><label>Password :</label></td>
<td><input type="text" name="uid" value="<%=rs.getString(2)%>"readonly="readonly"></td></tr>
